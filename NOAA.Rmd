...
First, we'll transform the data frame to get the event type with the most casualties for each state
...
Now let's create tables listing the states and their worst event types for human health and economic losses. 

```{R}
kable(dataHarmed, caption="Figure 1. Most harmful storm event types across
                           the United States by number of casualties.")



kable(dataDamaged, caption="Figure 2. Most harmful storm event types across
