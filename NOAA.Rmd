...
```{R, echo=TRUE, OUTPUT=FALSE, message=F, warning=F}
...
barplot(dataLoss$LOSS, names.arg=dataLoss$EVTYPE, ylab="Economic Cost ($)", main="Economic Losses By Event Type in the US", col="red", las=3)
```
